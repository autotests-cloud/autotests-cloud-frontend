...
function selectingAllNestedCheckboxes(parents, childs, className) {
  ...
  parents.onclick = function () {
    ...
    export { informationToggle, mainFormSectionToggle, calcContentHeight, mainBtn, mainBtn2, appBlock, 
        mainFormSize, body, mainForm, modalBtn, modalBtnClose, optionsBtn, informationSection, 
        titleTextarea, consoleContainer, consoleContainerContent, selectingAllNestedCheckboxes, 
        checkAllGithub,  checkBoxesGithub, checkAllJenkins, checkBoxesJenkins }